...
documents = []
ignore_words = ['?', '!']
data_file = open('my_chatbot/intents.json').read()
...
pickle.dump(words, open('my_chatbot/words.pkl', 'wb'))
pickle.dump(classes, open('my_chatbot/classes.pkl', 'wb'))
...
model.save('my_chatbot/chatbot_model.h5')
